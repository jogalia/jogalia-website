...
onMounted(() => {
  ...
  script.onload = () => {
    ...
    player.addEventListener((window as any).Twitch.Player.ONLINE,  () => { isLive.value = true  })
    player.addEventListener((window as any).Twitch.Player.OFFLINE, () => { isLive.value = false })
  }
  document.head.appendChild(script)
})

onBeforeUnmount(() => { player = null })
</script>
